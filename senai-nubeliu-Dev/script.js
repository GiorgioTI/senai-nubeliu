	...
	ColectApp.config(function($routeProvider) {
		$routeProvider
            ...
            //rota da manutençao para edicao
            .when('/categoria-create', {
				templateUrl : 'pages/categoria-create.html',
				controller  : 'categoria-createController'
			})
            //rota da manutençao para a edicao
            .when('/categoria-edicao', {
				templateUrl : 'pages/categoria-edicao.html',
				controller  : 'categoria-edicaoController'
			})
            //rota da manutençao para deletar
            .when('/categoria-delete', {
				templateUrl : 'pages/categoria-delete.html',
				controller  : 'categoria-deleteController'
			})
            //rota da manutençao para listar
            .when('/categoria-edicao', {
				templateUrl : 'pages/categoria-edicao.html',
				controller  : 'categoria-edicaoController'
			});
